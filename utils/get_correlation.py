...
model_dir_list=glob.glob(model_dir+"**/*.h5",recursive=True)
print(model_dir_list)
result=evl.get_coefficient(model_dir_list,data_split,n_samples=args.n_sample,batch_size=args.batch_size)
print(result)